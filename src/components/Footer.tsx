    ...
    <footer className="bg-black/50 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="h-6 w-6 bg-gradient-to-br from-neon-blue to-neon-purple rounded-md"></div>
              <span className="text-lg font-bold glow-text">MotionAI</span>
            </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          <p>© 2025 MotionAI. All rights reserved.</p>
